/**************************
Filename:  ExperimentalKbpfAnalyzer.cpp
...
#include "ExperimentalKbpfAnalyzer.h"


ExperimentalKbpfAnalyzer::ExperimentalKbpfAnalyzer()
{
}
...
bool ExperimentalKbpfAnalyzer::Analyze(AnalysisType analysistype,
                           TimePeriodType timeperiodtype,
                           int timeQuantity,
                           AggregationType aggregationType)
{
...
QDeclarativeView * ExperimentalKbpfAnalyzer::getGraph()
{
    return m_grapher->getGraph();
}

// Change graph size
void ExperimentalKbpfAnalyzer::setGraphSize(int width, int height) {
    m_graphWidth=width;
    m_graphHeight=height;
}

// Public aliases for Analyze() function
bool ExperimentalKbpfAnalyzer::AnalyzeEventLastXHours(int numHours){
    return Analyze(EventCount, Hour, numHours, None);
}
bool ExperimentalKbpfAnalyzer::AnalyzeEventLastXWeeks(int numWeeks){
    return Analyze(EventCount, Week, numWeeks, None);
}
bool ExperimentalKbpfAnalyzer::AnalyzeDurationLastXHours(int numHours){
    return Analyze(DurationAverage, Hour, numHours, None);
}
bool ExperimentalKbpfAnalyzer::AnalyzeDurationLastXWeeks(int numWeeks){
    return Analyze(DurationAverage, Week, numWeeks, None);
}
bool ExperimentalKbpfAnalyzer::AnalyzeEventLastXWeeksAggregateByClockHour(int numWeeks){
    return Analyze(EventCount, Week, numWeeks, ClockHour);
}
bool ExperimentalKbpfAnalyzer::AnalyzeEventLastXWeeksAggregateByWeekday(int numWeeks){
    return Analyze(EventCount, Week, numWeeks, Weekday);
}
bool ExperimentalKbpfAnalyzer::AnalyzeDurationLastXWeeksAggregateByClockHour(int numWeeks){
    return Analyze(DurationAverage, Week, numWeeks, ClockHour);
}
bool ExperimentalKbpfAnalyzer::AnalyzeDurationLastXWeeksAggregateByWeekday(int numWeeks){
    return Analyze(DurationAverage, Week, numWeeks, Weekday);
}
bool ExperimentalKbpfAnalyzer::graphAvgSessionDurationLast24Hours(){
    return AnalyzeDurationLastXHours(24);
}
bool ExperimentalKbpfAnalyzer::graphSessionCountLast24Hours(){
    return AnalyzeEventLastXHours(24);
}
bool ExperimentalKbpfAnalyzer::graphAvgSessionDurationLast4Weeks(){
    return AnalyzeDurationLastXWeeks(4);
}
bool ExperimentalKbpfAnalyzer::graphSessionCountLast4Weeks(){
    return AnalyzeEventLastXWeeks(4);
}
bool ExperimentalKbpfAnalyzer::graphHourlyAvgSessionDurationLast4Weeks(){
    return AnalyzeDurationLastXWeeksAggregateByClockHour(4);
}
bool ExperimentalKbpfAnalyzer::graphDailyAvgSessionDurationLast4Weeks(){
    return AnalyzeDurationLastXWeeksAggregateByWeekday(4);
}
bool ExperimentalKbpfAnalyzer::graphHourlySessionCountLast4Weeks(){
    return AnalyzeEventLastXWeeksAggregateByClockHour(4);
}
bool ExperimentalKbpfAnalyzer::graphDailySessionCountLast4Weeks(){
...
int ExperimentalKbpfAnalyzer::numDataPoints(AggregationType at, TimePeriodType tpt, int timeQuantity)
{
    if (at == ClockHour)
    {
...
uint ExperimentalKbpfAnalyzer::MaxTime(TimePeriodType tpt)
{
    if (tpt == Hour)
    {
...
uint ExperimentalKbpfAnalyzer::MinTime (uint maxTime, TimePeriodType tpt, int timeQuantity)
{
    if (tpt == Hour)
    {
...
QString * ExperimentalKbpfAnalyzer::GraphXValues(int num_data_points, uint maxTime, AggregationType at, TimePeriodType tpt)
{
...
int ExperimentalKbpfAnalyzer::GraphIndex(AggregationType aggregationType, TimePeriodType timeperiodtype, int num_data_points, uint starttime, uint minTime)
{
...
void ExperimentalKbpfAnalyzer::makeGraphPoints(QList<QPair<QString,QString> > & graphPoints, AggregationType at, int num_data_points, QString* graphXValues, int* graphYValues)
{
...
QString ExperimentalKbpfAnalyzer::XLabel(AggregationType aggregationType, TimePeriodType timeperiodtype)
{
...
QString ExperimentalKbpfAnalyzer::YLabel(AnalysisType analysistype)
{
...
QString ExperimentalKbpfAnalyzer::GraphTitle(AnalysisType analysistype, TimePeriodType timeperiodtype, AggregationType aggregationtype, int timeQuantity)
{
